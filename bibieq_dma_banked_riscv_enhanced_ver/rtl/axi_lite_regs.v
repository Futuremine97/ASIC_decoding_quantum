...
`include "csr_map.vh"
    ...
    assign ctrl_write   = write_fire && (awaddr_hold[11:0] == `CSR_CTRL) && wmask[0];
    assign start_req    = ctrl_write && wdata_hold[`CSR_CTRL_START] && ~busy;
    assign clr_done_req = ctrl_write && wdata_hold[`CSR_CTRL_CLR_DONE];
    assign soft_reset_req = ctrl_write && wdata_hold[`CSR_CTRL_SOFT_RESET];
